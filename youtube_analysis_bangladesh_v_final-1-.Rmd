---
title: "Text Analytics on Youtube Videos Posted About 'Bangladesh'"
...
``` {r }
videos_year = read.csv('youtube_video_raw+stat_2017-2018.csv')
dim(videos_year)
names(videos_year)
```
...
```{r}
# videos_year = read.csv('cleaned_youtube_video_2017-2018.csv')
